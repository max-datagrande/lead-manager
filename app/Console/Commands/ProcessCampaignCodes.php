...
class ProcessCampaignCodes extends Command
{
  ...
  public function handle()
  {
    ...
    $totalRecords = TrafficLog::whereNull('campaign_code')->whereNotNull('query_params')->count();
    ...
    do {
      ...
      $records = TrafficLog::whereNull('campaign_code')->whereNotNull('query_params')->offset($offset)->limit($batchSize)->get();
