...
class LeadController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    $leadQuery = Lead::with('fields:id,name,label')->select('leads.*');
    ...
    $leads = $leadQuery->paginate($perPage)->appends($request->only('search', 'host', 'start_date', 'end_date', 'sort', 'direction'));
    $data = [
      'fields' => Field::select('id', 'name', 'label')->orderBy('name')->get(),
      'leads' => $leads,
  ...
  public function export(Request $request)
  {
    ...
    return response()->streamDownload(
      function () use ($search, $host, $startDate, $endDate, $sort, $direction, $allFields) {
