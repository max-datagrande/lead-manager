...
{
  public function __construct(protected MaxconvService $maxconvService) {}
  ...
  public function buildOfferUrl(Request $request): JsonResponse
  {
    ...
    $url = $this->maxconvService->buildOfferUrl($request->input('offer_id'), $request->input('data'));
  ...
  public function validatePlaceholders(Request $request): JsonResponse
  {
    ...
    $missingPlaceholders = $this->maxconvService->validatePlaceholders($request->input('url'), $request->input('data'));
