...
class Buyer extends Model
{
  ...
  protected $fillable = ['name', 'integration_id', 'company_id', 'is_active'];
  ...
  {
    return $this->hasMany(BuyerEligibilityRule::class, 'integration_id', 'integration_id')->orderBy('sort_order');
  }
