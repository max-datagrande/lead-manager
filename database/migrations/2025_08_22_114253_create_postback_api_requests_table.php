...
return new class extends Migration
{
  ...
  public function up(): void
  {
    Schema::create('postback_api_requests', function (Blueprint $table) {
      ...
      $table->unsignedBigInteger('postback_id')->nullable(); // ID del registro relacionado
      ...
      $table->index(['related_type', 'postback_id']);
  ...
  {
    Schema::dropIfExists('postback_api_requests');
  }
};
