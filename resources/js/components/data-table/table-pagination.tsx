...
export function DataTablePagination<TData>({ table }: DataTablePaginationProps<TData>) {
  ...
  return (
    <div
      className={cn('flex items-center justify-between overflow-clip px-2', '@max-2xl/main:flex-col-reverse @max-2xl/main:gap-4')}
    ...
    >
      ...
      <div className="flex items-center sm:space-x-6 lg:space-x-8">
        <div className="mr-0 flex w-[100px] items-center justify-center text-sm font-medium @max-3xl/main:hidden">
